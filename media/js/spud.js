    ...
    for (_i = 0, _len = postConditions.length; _i < _len; _i++) {
      ...
      switch (postCondition.type) {
        ...
        case 'output':
          ...
          } else if (postCondition.parameter === "not") {
...
Chip = (function() {
  ...
  Chip.prototype.receive = function(method, data) {
    var action, args, callback, state, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _results, _results1, _results2, _results3;
    switch (method) {
      case 'ready':
